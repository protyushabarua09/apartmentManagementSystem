...
include(ROOT_PATH.'language/'.$lang_code_global.'/lang_owner_employee_details.php');
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
                $result = mysqli_query($link, "SELECT *,mt.member_type FROM tbl_add_employee e inner join tbl_add_member_type mt where mt.member_id = e.e_designation");
            ...
            <td><?php echo $row['e_per_address']; ?></td>
            <td><?php echo $row['member_type']; ?></td>
            <td><?php echo $row['e_date']; ?></td>
            <td>
            <a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onclick="$('#nurse_view_<?php echo $row['eid']; ?>').modal('show');" data-original-title="View"><i class="fa fa-eye"></i></a>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-xs-12"> 
                        <b><?php echo $_data['text_2'];?> :</b> <?php echo $row['e_name']; ?><br/>
                        <b><?php echo $_data['text_3'];?> :</b> <?php echo $row['e_email']; ?><br/>
                        <b><?php echo $_data['text_4'];?> :</b> <?php echo $row['e_contact']; ?><br/>
                        <b><?php echo $_data['text_5'];?> :</b> <?php echo $row['e_pre_address']; ?><br/>
                        <b><?php echo $_data['text_9'];?> :</b> <?php echo $row['e_per_address']; ?><br/>
                        <b><?php echo $_data['text_6'];?> :</b> <?php echo $row['member_type']; ?><br/>
                        <b><?php echo $_data['text_7'];?> :</b> <?php echo $row['e_date']; ?><br/>
                      </div>
                    </div>
                  </div>
