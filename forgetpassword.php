...
if(isset($_POST['username']) && $_POST['username'] != ''){
    ...
    if($_POST['ddlLoginType'] == '1'){
        ...
        //here for teacher
        $sql= mysqli_query($link, "SELECT * FROM tbl_add_owner WHERE o_email = '".make_safe($_POST['username'])."'");
        $password = 'o_password';
    }
    else if($_POST['ddlLoginType'] == '3'){
        //here for student
        $sql= mysqli_query($link, "SELECT * FROM tbl_add_employee WHERE e_email = '".make_safe($_POST['username'])."'");
        $password = 'e_password';
    }
...
<title>BLUE Apartment Management System</title>
<!-- BOOTSTRAP STYLES-->
...
<div class="container">
  ...
  <div class="row text-center ">
    <div class="col-md-12"><br/>
      <span style="font-size:35px;font-weight:bold;color:red;">BLUE</span> <span style="font-size:18px;">Apartment Management System</span></div>
  </div>
  <br/>
  <div class="row ">
